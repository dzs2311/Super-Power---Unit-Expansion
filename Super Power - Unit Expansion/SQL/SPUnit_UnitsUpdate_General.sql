...
UPDATE Units SET IconAtlas = 'UNIT_SPUE_OTTOMAN_ATLAS', 			PortraitIndex = 0 			WHERE Type = 'UNIT_OTTOMAN_PRIVATEER';	-- 奥斯曼私掠舰
--==========================================================================================================================
-- Unit_Misc
--==========================================================================================================================
-- 玄甲军55力
...
SELECT	'UNIT_SPUE_TOWEREDSHIP', 	'UNITCLASS_SPUE_TOWEREDSHIP', 	PrereqTech, 				45,				75,		  	2, 	 	ExtraMaintenanceCost,	Special, 160, 	FaithCost,  HurryCostModifier, RequiresFaithPurchaseEnabled, 5,   	  	'UNITCOMBAT_NAVALRANGED', 	Domain, DefaultUnitAI, 'TXT_KEY_UNIT_SPUE_TOWEREDSHIP',	'TXT_KEY_CIV5_SPUE_TOWEREDSHIP_TEXT', 	'TXT_KEY_PROMOTION_NAVAL_RANGED_SHIP_STRATEGY', 	Help, 										Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, 'TECH_GUILDS',   	XPValueAttack, XPValueDefense, 'UNITCLASS_GREAT_GALLEASS', 'ART_DEF_UNIT_SPUE_TOWEREDSHIP',		1,					'SPUE_UNIT_FLAG_ATLAS',		1,				'SPUE_UNITS_ATLAS'
